...
import { Button, Avatar, Popper, Paper, ClickAwayListener, MenuItem, ListItemIcon } from '@mui/material';
    ...
    <header className="bg-gray-900 text-white py-4 fixed top-0 left-0 w-full z-50 shadow-lg">
      <div className="max-w-6xl mx-auto flex justify-between items-center px-4">
        <div className="flex items-center space-x-2">
          ...
          <Link to="/" className="text-2xl font-bold hover:text-teal-400">WorkNet</Link>
        </div>
